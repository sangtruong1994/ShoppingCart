...
<head>
<meta charset="UTF-8">
<title>Account Users List</title>
<link rel="stylesheet"
		...
		<div class="table-responsive">
			<div class="table-wrapper">
				...
				<table class="table table-striped table-hover">
					...
					<tbody>
						<c:forEach var="accountInfo"
							items="${paginationAccountInfos.list}">
							<tr>
								<td><c:out value="${accountInfo.username}"></c:out></td>
								<td><c:out value="${accountInfo.password}"></c:out></td>
								<td><c:out value="${accountInfo.userRole}"></c:out></td>
								<td><c:out value="${accountInfo.active}"></c:out></td>
								<td colspan="2"><a
									href="${contextPath}/account?username=${accountInfo.username}"
